# -*- coding: utf-8 -*-
"""
Created on Wed Aug 27 18:19:04 2025
...
for mo in MODEL:
    ...
    CDHEs_dataf[mo] = {'future_frequency':CDHF2s,'future_days':CDHD2s,'future_area':CDHA2s,'future_intensity':CDHI2s}
                
import pickle
 

#CDHEs_data = pd.DataFrame(CDHEs_data)
DATA = {'h':CDHEs_datah,'f':CDHEs_dataf}
with open('../data/Model_CDHEs_data2.pkl', 'wb') as f:
	pickle.dump(DATA, f)            
