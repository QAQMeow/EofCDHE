...
dsr = nc.Dataset('../data/popf2/BaseYear/2000rurall.nc')
dsu = nc.Dataset('../data/popf2/BaseYear/2000urban.nc')
dst = nc.Dataset('../data/popf2/BaseYear/2000total.nc')
lon1 = dsr['lon'][:]
...
aspr = get05data(pop_r)    
aspu = get05data(pop_u)  
aspt = get05data(pop_t)  
D = {}
D[2000] = {'Total':np.array(aspt)*m1,'Rural':np.array(aspr)*m1,'Urban':np.array(aspu)*m1}
    
    
with open('../data/ASPOP_URh.pkl', 'wb') as f:
