# -*- coding: utf-8 -*-
"""
Created on Fri Jun 20 10:38:15 2025
        ...
        for timep in tp:
            for period1 in Period1:
                for period2 in Period2:
                    ...
                    if not os.path.isfile(d1+'/'+d2+'/'+period2+'_'+var+'_br_daily_'+timep+'.nc'):
                        ...
                        NewData = nc.Dataset(d1+'/'+d2+'/'+period2+'_'+var+'_br_daily_'+timep+'.nc', 'w', format='NETCDF4')
                        NewData.description = period2+'_'+var+'_br_daily_'+timep
